<%@ Control Language="VB" AutoEventWireup="false" CodeFile="notify.ascx.vb" Inherits="notify" %>
...
<dx:ASPxGridView ID="gv_alert" runat="server" AutoGenerateColumns="False" Width="100%" Theme="Office2010Blue">
